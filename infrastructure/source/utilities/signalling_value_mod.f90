...
interface get_signalling_value
  module procedure get_r32_signalling_value, get_r64_signalling_value, &
                   get_i32_signalling_value
...
function get_r32_signalling_value(type_variable) result(signalling_value)
...
end function get_r32_signalling_value
...
function get_r64_signalling_value(type_variable) result(signalling_value)
real(real64), intent(in) :: type_variable
real(real64) :: signalling_value
signalling_value = ieee_value(type_variable, IEEE_SIGNALING_NAN)
end function get_r64_signalling_value
...
function get_i32_signalling_value(type_variable) result(signalling_value)
integer(int32), intent(in) :: type_variable
integer(int32) :: signalling_value
signalling_value = -huge(type_variable)
end function get_i32_signalling_value
