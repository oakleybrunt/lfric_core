...
module consistent_hori_ix_deppt_kernel_mod
...
type, public, extends(kernel_type) :: consistent_hori_ix_deppt_kernel_type
  private
...
contains
  procedure, nopass :: consistent_hori_ix_deppt_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: consistent_hori_ix_deppt_code
...
!> @param[in]     rho_d             The dry density field before the x-direction
!!                                  transport step
...
subroutine consistent_hori_ix_deppt_code( nlayers,             &
                                          dep_pts_x,           &
                                          frac_dry_flux,       &
                                          dry_flux,            &
                                          rho_d,               &
    ...
    do df_idx = 1, df_ctr
      ...
      do k = 0, nlayers - 1
        ...
        if (num_int_cells < stencil_extent) then
          ...
          write(log_scratch_space, '(A,I8)') 'consistent_hori_ix: Consistent ' // &
...
end subroutine consistent_hori_ix_deppt_code

end module consistent_hori_ix_deppt_kernel_mod
