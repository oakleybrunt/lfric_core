...
module consistent_hori_oy_deppt_kernel_mod

use argument_mod,                only : arg_type,                  &
                                        GH_FIELD, GH_REAL,         &
                                        GH_WRITE, GH_READ,         &
                                        GH_SCALAR, GH_INTEGER,     &
                                        STENCIL, Y1D, CELL_COLUMN, &
...
type, public, extends(kernel_type) :: consistent_hori_oy_deppt_kernel_type
  private
  type(arg_type) :: meta_args(10) = (/                                       &
       ...
       arg_type(GH_SCALAR, GH_LOGICAL, GH_READ)                              & ! cap_dep_pts
       /)
  integer :: operates_on = CELL_COLUMN
contains
  procedure, nopass :: consistent_hori_oy_deppt_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: consistent_hori_oy_deppt_code
...
subroutine consistent_hori_oy_deppt_code( nlayers,             &
                                          dep_pts_y,           &
                                          frac_dry_flux,       &
                                          dry_flux,            &
                                          rho_d_x,             &
  ...
  real(kind=r_tran)   :: rho_d_local(stencil_size_x)
  ...
  ! ========================================================================== !
    ...
    do df_idx = 1, df_ctr
      ...
      do k = 0, nlayers - 1
        ...
        do j = stencil_half+1, stencil_size_x
        ...
        if (num_int_cells < stencil_extent) then
          ...
          write(log_scratch_space, '(A,I8)') 'consistent_hori_oy: Consistent ' // &
...
end subroutine consistent_hori_oy_deppt_code

end module consistent_hori_oy_deppt_kernel_mod
