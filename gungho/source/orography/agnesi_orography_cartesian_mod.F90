...
!>                    function (m),
!>          direction_cart - Direction of Witch-of-Agnesi mountain function
!>                           (x, y or both).
!-------------------------------------------------------------------------------
...
contains
  ...
  subroutine agnesi_coordinate_cartesian(self, chi_1, chi_2, chisurf_arg)
    ...
    integer(kind=i_def), parameter :: direction_x = &
                         int(orography_agnesi_cartesian_direction_x, i_def)
    integer(kind=i_def), parameter :: direction_y = &
                         int(orography_agnesi_cartesian_direction_y, i_def)
